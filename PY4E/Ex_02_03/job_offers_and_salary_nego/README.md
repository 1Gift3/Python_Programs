# WHAT
# This is a simple program for Job offers and salary negotiations proess between you a job candidate and the employer.
# This too can be very neccessary for KasiLink
# The program is made up of three main functions
# Job_offer() - Which annouces a job offer
...
# Function iii
# What happens here is the program sets tjob title and base salary 
# Prompts you the user for your expected salary
# Calls jobs_offer() function to show the initial offer.
# Calls again negotiate_salary() function to handle any potential negotiations
